...
RUN_STRINGS = (
    ...
    "Now I'm always running!",
    "Why so serious try /kickme!",
    "Run like there's a hot girl in front of you and a creepy one behind you.",
    "Running won't solve all your problems. But then again, neither will housework.",
    "Why you used this command!",
    "Huh next usain bolt is here ;_;",
    "If you're good at running never do it for free!",
    "Are you human try something new always running!",
    ...
    "Nu run plz",
    "My powers brings all the users kick with this command /kickme",
